...
async def run() -> int:
    args = parse_args()
    try:
        import activities_emma as activities_module
        ...
        archive_transcript_entry = activities_module.archive_transcript_entry
    except Exception as exc:
        print(
            "[temporal-worker] impossible de charger activities_emma.py. "
