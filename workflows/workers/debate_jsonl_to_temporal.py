...
# Support direct execution: `python workers/debate_jsonl_to_temporal.py`.
    ...
    *,
    ...
    for idx, (_, payload) in enumerate(window_payloads):
        ...
        if phrase:
            ...
            # Keep previous context without duplicating the current phrase.
            if idx < window_len - 1:
...
async def run() -> int:
    load_workflows_env(override=True)
    args = parse_args()
