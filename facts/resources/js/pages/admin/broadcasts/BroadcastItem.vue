...
import { close } from '../../../routes/admin/broadcasts';
...
function closeBroadcast() {
    ...
    router.post(close(props.broadcast.id));
}
</script>
...
<template>
    ...
    >
        ...
        >
            <p class="mb-1 text-xs font-semibold uppercase tracking-wide text-gray-400">TL;DR – AI Synthesis</p>
            <p class="whitespace-pre-wrap leading-relaxed">{{ broadcast.summary }}</p>
        </div>
